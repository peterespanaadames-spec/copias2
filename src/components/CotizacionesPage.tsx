              ...
              <div className="bg-[#F8F9FA] border border-gray-200 p-4 rounded-2xl space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[11px] font-montserrat font-extrabold text-[#00BFFF] hover:text-[#00BFFF]/85 flex items-center gap-1 transition-all active:scale-95 cursor-pointer bg-sky-50 px-2 py-0.5 rounded-md border border-sky-200"
                  >
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <select
                      ...
                      className="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-xl text-xs font-bold text-[#2B2D42] focus:outline-none focus:ring-2 focus:ring-[#00BFFF]"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => setShowNewClientModal(true)}
                      className="px-3.5 py-2 bg-[#1D3557] hover:bg-[#152742] text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5 shrink-0 shadow-xs cursor-pointer active:scale-95"
            ...
            <form onSubmit={handleSaveNewClient} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100 grid grid-cols-2">
                <button
                  ...
                  className="w-full py-3 bg-gray-100 hover:bg-gray-200/80 text-[#2B2D42] font-montserrat font-black text-xs uppercase tracking-wider rounded-[14px] transition cursor-pointer active:scale-98"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={isSavingClient}
                  className="w-full py-3 bg-[#13D5C5] hover:bg-[#0fc3b4] text-white font-montserrat font-black text-xs uppercase tracking-wider rounded-[14px] shadow-md hover:shadow-lg transition flex items-center justify-center gap-1.5 cursor-pointer active:scale-98"
                >
                  {isSavingClient ? (
                    <>
