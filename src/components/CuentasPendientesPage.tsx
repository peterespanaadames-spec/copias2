                      ...
                      <td className="py-3.5 px-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1D3557]/10 hover:bg-[#1D3557] hover:text-white text-[#1D3557] font-montserrat font-extrabold rounded-xl border border-[#1D3557]/20 transition-all active:scale-95 text-xs whitespace-nowrap cursor-pointer shadow-2xs"
                          >
