...
import { 
  ...
  ChevronDown, ChevronRight, PieChart, Wallet, CreditCard, Scale, Zap, Receipt, FileSpreadsheet,
  History, Link2
} from 'lucide-react';
...
const VentasFlashModule = lazy(() => import('./VentasFlashModule.tsx'));
const SalesReportPage = lazy(() => import('./SalesReportPage.tsx'));
...
const ProductHistoryModal = lazy(() => import('./ProductHistoryModal.tsx'));
...
const ReportesCuentasPage = lazy(() => import('./ReportesCuentasPage.tsx'));
const ClientsManagerModule = lazy(() => import('./ClientsManagerModule.tsx'));
            ...
            <form onSubmit={handleSaveProduct} className="p-6 overflow-y-auto flex-1 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 flex justify-end gap-2.5">
                <button
                  type="button"
                  onClick={() => setShowProductModal(false)}
                  className="px-4 py-2.5 border border-gray-300 text-[#2B2D42] rounded-xl text-xs font-montserrat font-bold hover:bg-gray-100 transition cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-[#005da9] to-[#1D3557] hover:from-[#004b88] hover:to-[#152740] text-white font-montserrat font-extrabold rounded-xl text-xs flex items-center gap-2 cursor-pointer shadow-md hover:shadow-lg transition active:scale-95 border-b-2 border-[#1D3557]/30"
